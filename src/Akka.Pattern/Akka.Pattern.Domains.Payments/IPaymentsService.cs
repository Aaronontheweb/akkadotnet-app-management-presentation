...
{
    Task<PaymentsResponse> CreatePayment(string subscriptionId, string productId, string userId, decimal amountToCharge);
}


public sealed class DefaultPaymentsService : IPaymentsService
{
    public Task<PaymentsResponse> CreatePayment(string subscriptionId, string productId, string userId, decimal amountToCharge)
    {
